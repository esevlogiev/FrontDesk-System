...
import gui.add_new_room
import gui.cancel_reservation
import gui.show_client
import gui.add_food
import gui.add_reservation
import gui.add_new_client
import gui.add_item
import gui.cancel_reservation
import gui.show_room_items
from management.room_management import (release_room, change_bath_item,
                                        change_food, get_all_rooms_number,
                                        get_all_rooms,
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        reservation_management_menu = main_menu.addMenu(
        ...
        make_reservation_action.triggered.connect(
            self.make_reservation_form_load)
        reservation_management_menu.addAction(
            make_reservation_action)
        cancel_reservation_action = QAction('Cancel Reservation', self)
        cancel_reservation_action.triggered.connect(
            self.cancel_reservation_form_load)
    ...
    def room_number_input_dialog(self):
        ...
        return QInputDialog.getInt(self, "Release",
                                   "Enter room number({0}-{1})".format
                                   (str(min_room_number),
                                    str(max_room_number)),
                                   self.room, min_room_number,
                                   max_room_number)
    ...
    def release_room_load(self):
        ...
        if ok:
            if not (room_number in get_all_rooms_number()):
                ...
                notifier.setWindowIcon(QIcon(
                    QPixmap(':/images/hotel_icon.jpg')))
                notifier.exec_()
    ...
    def show_maid_model(self):
        ...
        self.maids_table.setSizeAdjustPolicy(
    ...
    def show_reservations(self):
        ...
        self.reservations_table.setSizeAdjustPolicy(
            QAbstractScrollArea.AdjustToContents)
    ...
    def show_rooms(self):
        ...
        self.rooms_table.setSizeAdjustPolicy(
            QAbstractScrollArea.AdjustToContents)
    ...
    def show_clients(self):
        ...
        self.clients_table.setSizeAdjustPolicy(
            QAbstractScrollArea.AdjustToContents)
        self.model = ClientsModel()
    ...
    def about(self):
        QMessageBox.about(self, "About",
                          ...
                          <p>Registered to Evgeny Evlogiev</p><p>Email:" +
                          " evgenistefchov@abv.bg</p>")
