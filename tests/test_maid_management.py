...
class MaidsManagementTest(unittest.TestCase):
    ...
    def test_add_maid_to_serve_client(self):
        ...
        add_maid_to_serve_client('Kiril', 'Georgiev', 2, TEST_DATABASE_FILENAME)
        add_maid_to_serve_client('Nikola', 'Todorov', 3, TEST_DATABASE_FILENAME)
        maids = get_all_maids(TEST_DATABASE_FILENAME)
        self.assertCountEqual(maids, [('Petyr', 'Ivanov'),
                                      ('Kiril', 'Georgiev'),
                                      ('Nikola', 'Todorov')])
    ...
    def test_choose_maid(self):
        ...
        add_maid_to_serve_client('Kiril', 'Georgiev', 2, TEST_DATABASE_FILENAME)
        add_maid_to_serve_client('Nikola', 'Todorov', 3, TEST_DATABASE_FILENAME)
        add_maid_to_serve_client('Kiril', 'Georgiev', 4, TEST_DATABASE_FILENAME)
        add_maid_to_serve_client('Nikola', 'Todorov', 5, TEST_DATABASE_FILENAME)
        add_maid_to_serve_client('Kiril', 'Georgiev', 6, TEST_DATABASE_FILENAME)
    ...
    def test_get_maid_names(self):
        ...
        add_maid_to_serve_client('Kiril', 'Georgiev', 2, TEST_DATABASE_FILENAME)
        add_maid_to_serve_client('Nikola', 'Todorov', 3, TEST_DATABASE_FILENAME)
        self.assertEqual('Petyr Ivanov', get_maid_names(1, TEST_DATABASE_FILENAME))
        self.assertEqual('Kiril Georgiev', get_maid_names(2, TEST_DATABASE_FILENAME))
        self.assertEqual('Nikola Todorov', get_maid_names(3, TEST_DATABASE_FILENAME))
        self.assertNotEqual('Petyr Ivanov', get_maid_names(3, TEST_DATABASE_FILENAME))
        self.assertNotEqual('Kiril Georgiev', get_maid_names(1, TEST_DATABASE_FILENAME))
        self.assertNotEqual('Nikola Todorov', get_maid_names(2, TEST_DATABASE_FILENAME))
